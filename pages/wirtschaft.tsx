...
export const getServerSideProps: GetServerSideProps = async () => {
  const res = await fetch(
    'https://newsapi.org/v2/top-headlines?country=de&category=business&pageSize=100&apiKey=f02e1a6900994374b4a26266442674b1'
  )
...
const Wirtschaft: NextPage = ({ data }: any) => {
  // console.log(data);
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <h1 className="mt-6 text-6xl font-bold">Wirtschaft News</h1>
